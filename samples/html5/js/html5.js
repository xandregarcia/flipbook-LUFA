...
(function ($) {
  ...
  function isChrome() {
    return (
      navigator.userAgent.indexOf("Chrome/19") != -1 ||
  ...
  function updateDepth(book, newPage) {
    ...
    else $(".html5-book .p2 .depth").css({ width: 0 });
    ...
    else $(".html5-book .p101 .depth").css({ width: 0 });
  }

  function loadPage(page) {
    $.ajax({
      url: samplePath + "pages/page" + page + ".html?" + Math.random(),
    ...
    flipbook.turn({
      ...
      when: {
        turning: function (e, page, view) {
          ...
          if (page >= 2) $(".html5-book .p2").addClass("fixed");
          else $(".html5-book .p2").removeClass("fixed");

          if (page < book.turn("pages"))
            $(".html5-book .p101").addClass("fixed");
          else $(".html5-book .p101").removeClass("fixed");
          ...
          sample.flipbook = $("<div />", { class: bookClass })
            .html(
              '<div depth="5" class="hard"> <div class="side"></div> </div>' +
                ...
                '<div class="hard fixed back-side p101"> <div class="depth"></div> </div>' +
                '<div class="hard p102"></div>'
            )
            .appendTo($("#book-zoom"));
